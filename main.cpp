...
Blitz2k18 * my_game; //Is a pointer to avoid problems with assignment, dynamic memory, and default constructors.
...
int main(int argc, char ** argv) {
    ...
    TCLAP::CmdLine cmd("Blitz2k18 Game Environment", ' ', "1.2");
    ...
    TCLAP::ValueArg<unsigned int> fogOfWarArg("f", "fog", "The fog of war visibility range.", false, 100, "positive integer", cmd);
    ...
    // Fog of war
    unsigned short fogOfwar = fogOfWarArg.getValue();
    ...
    my_game = new Blitz2k18(mapWidth, mapHeight, fogOfwar, seed, n_players_for_map_creation, networking, ignore_timeout);
