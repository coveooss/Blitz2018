...
public class Map
{
    public void Update(string productionMapStr, string gameMapStr) {
	UpdateProduction(this, productionMapStr);
    ...
    public static void UpdateProduction(Map map, string productionMapStr) {
	...
	UpdateProduction(map, productionMapStr);

        map.Update(productionMapStr, gameMapStr);
